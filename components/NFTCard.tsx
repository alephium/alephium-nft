  ...
  return (
    <Link href={{ pathname: '/nft-details', query: { tokenId: nft.tokenId } }}>
      <motion.div
        ...
        className="flex-1 min-w-215 xs:max-w-none sm:w-full sm:min-w-155 minmd:min-w-256 minlg:min-w-256 dark:bg-nft-black-3 bg-white rounded-2xl p-4 m-4 minlg:m-100 sm:my-2 sm:mx-2 cursor-pointer shadow-md hover:shadow-lg duration-500"
      >
